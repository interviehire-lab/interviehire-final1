...
export async function resetHiringDb(url: string): Promise<void> {
  ...
  try {
    await sql`TRUNCATE v2_resume_analysis_runs, v2_application_interview_refs, v2_application_decision_history, v2_application_stage_history, v2_hiring_outbox, v2_applications CASCADE`;
